export class Secrets {
  public static readonly WX_APPID: string = "${WX_APPID}";
  public static readonly WX_APPSECRET: string = "${WX_APPSECRET}";
  ...
  public static readonly TELEGRAM_AUTHENTICATION_TOKEN: string =
